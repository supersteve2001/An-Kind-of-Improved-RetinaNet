...
def main(args=None):
    ...
    ##
    writer = SummaryWriter('runs/retinanet_training')
    ##
    ...
    # optimizer = optim.SGD(retinanet.parameters(), lr=1e-4, momentum=0.9)
    ...
    for epoch_num in range(parser.epochs):
        ...
        for iter_num, data in tqdm(enumerate(dataloader_train)):
            ...
            ##
            writer.add_scalar('Loss/train', loss, epoch_num * len(dataloader_train) + iter_num)
            ##
